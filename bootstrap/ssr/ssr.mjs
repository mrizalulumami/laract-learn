...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.jsx`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.jsx": () => import("./assets/ConfirmPassword-117f3911.mjs"), "./Pages/Auth/ForgotPassword.jsx": () => import("./assets/ForgotPassword-3cedf250.mjs"), "./Pages/Auth/Login.jsx": () => import("./assets/Login-c7e8572c.mjs"), "./Pages/Auth/Register.jsx": () => import("./assets/Register-0974a917.mjs"), "./Pages/Auth/ResetPassword.jsx": () => import("./assets/ResetPassword-204c23c1.mjs"), "./Pages/Auth/VerifyEmail.jsx": () => import("./assets/VerifyEmail-4b19d4ee.mjs"), "./Pages/Dashboard.jsx": () => import("./assets/Dashboard-ef0c6e0a.mjs"), "./Pages/Profile/Edit.jsx": () => import("./assets/Edit-1909b5bb.mjs"), "./Pages/Profile/Partials/DeleteUserForm.jsx": () => import("./assets/DeleteUserForm-47ef68f1.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.jsx": () => import("./assets/UpdatePasswordForm-72417c63.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.jsx": () => import("./assets/UpdateProfileInformationForm-dc02a45d.mjs"), "./Pages/Welcome.jsx": () => import("./assets/Welcome-2d89121f.mjs") })),
    setup: ({ App, props }) => {
